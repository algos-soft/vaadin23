...
public enum EASchedule {
    ...
    /**
     * Descrizione: il 5 di ogni mese alle ore 6 di mattina
     */
    cinqueMese("0 6 5 * *", "il 5 di ogni mese alle ore 6 di mattina."),
    /**
     * Descrizione: il primo e il 15 di ogni mese alle ore 4 di notte
     */
    biMensile("0 4 1,15 * *", "il primo e il 15 di ogni mese alle ore 4 di notte."),
    /**
     * Descrizione: ogni giorno alle ore 1 di notte
     */
    oreUna("5 1 * * *", "ogni giorno alle ore 1:05 di notte."),
    /**
     * Descrizione: ogni giorno alle ore 2 di notte
     */
    oreDue("5 2 * * *", "ogni giorno alle ore 2:05 di notte."),
    /**
     * Descrizione: ogni giorno alle ore 4 di notte, escluso l'1 e il 15
     */
    oreQuattroEscluso("0 4 2-14,16-31 * *", "ogni giorno alle ore 4 di notte, escluso l'1 e il 15."),
    /**
